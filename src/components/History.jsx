...
const History = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-10">
      <h1 className="text-2xl mb-5 font-bold text-blue-400">
        Previous Datetime Table
      </h1>

      {loading==true && <ReactLoading type="ball" height={667} width={375} />    }
      {(datetimes.length == 0 && loading==false) ? (
        <Empty />
      ) : (
        <>
          ...
          <div className="flex gap-10 my-10">
            ...
            <button
              className={`${
                currentPage == totalPages || loading == true
